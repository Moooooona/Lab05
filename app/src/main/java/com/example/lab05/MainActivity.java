...
import com.example.lab05.Retrofit.RetrofitBuillder;
import com.example.lab05.Retrofit.Retrofitinterface;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Retrofitinterface retrofitInterface = RetrofitBuillder.getRetrofitInstance().create(Retrofitinterface.class);
